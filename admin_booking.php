    ...
    <div class="container">
		<div class="box">
            ...
            <div class="link-right">
                ...
                <button class="btn btn-secondary"><a href="admin_booking-upcoming.php" class="link-primary text-light">Upcoming Movies</a></button>
			...
			<table class="table table-striped text-center" id="myTable">
                ...
                <tbody>
                    <?php
                        $sql = "SELECT * FROM movies ORDER BY date_showing DESC";
